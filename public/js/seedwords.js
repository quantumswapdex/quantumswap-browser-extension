...
async function verifySeedWordAsync(friendlySeedIndex, seedWord, seedArray) {
    var expected = await getWordListFromSeedArrayAsync(seedArray);
    if (expected == null) {
        return false;
    }
